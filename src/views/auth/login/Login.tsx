...
const Login = () => {
    ...
    const [theme,setTheme] = useState(localStorage.getItem('deal-it-service-desk-theme') || 'light');
                            ...
                            <CCard className="p-4" >
                                <CCardBody>
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        ...
                                        <p className="text-body-secondary text-center">Zaloguj się na swoje konto</p>
                                        ...
                                        <CRow>
                                            <CCol style={{display:"flex",justifyContent:"center"}} xs={12}>
                                                <CButton style={{width:"100%"}} color="primary" className="px-4" type="submit"
                                                         disabled={isLogging}>
                                                    Zaloguj się
                                                </CButton>
                            ...
                            * <CCard className="text-white bg-primary py-5" style={{width: '44%'}}>
                                <CCardBody className="text-center">
                                    <div>
                                        ...
                                        <p>
                                            Nie masz jeszcze konta? Zarejestruj się teraz, aby uzyskać dostęp do wszystkich funkcji!
                                        </p>
                                        <Link to="/register">
